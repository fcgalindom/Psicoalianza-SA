...
<div class="row">
    <div class="col-12 col-md-4 mb-2">
        <button type="button"  data-bs-toggle="modal" data-bs-target="#deleteModal" class="btn btn">@include('icons.trash')</button>
        <button type="button" class="btn btn">@include('icons.download')</button>
    </div>
    <div class="col-12 col-md-6 mb-2 text-start">
        
    </div>
    <div class="col-12 col-md-2 mb-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
        ...
        <thead class="theadstyle">
            <tr>
             ...
             <div class="contenedor-padre">
                ...
                <th><div class="position-relative">
                    <div class="d-flex">
                ...
                <th><div class="position-relative">
                    <div class="d-flex">
                        <p style="padding: 0; margin:0;margin-right:0.5rem;">Direccion</p>
                        @include('icons.simple')
                ...
                <th><div class="position-relative">
                    <div class="d-flex">
                        <p style="padding: 0; margin:0;margin-right:0.5rem;">Telefono</p>
                        @include('icons.simple')
                ...
                <th><div class="position-relative">
                    <div class="d-flex">
                        <p style="padding: 0; margin:0;margin-right:0.5rem;">Ciudad</p>
                        @include('icons.simple')
                ...
                <th><div class="position-relative">
                    <div class="d-flex">
                        <p style="padding: 0; margin:0;margin-right:0.5rem;">Pais</p>
                        @include('icons.simple')
        ...
        <tbody>
            @foreach ($users as $user)
                <tr>
                    ...
                    <td>
                        <div class="d-flex">
                            <button type ="button" class="btn" data-bs-toggle="modal" data-bs-target="#editmodal">@include('icons.editsimple')</button>
